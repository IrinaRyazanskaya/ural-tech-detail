    ...
    return (
        <article className="guarantees">
            ...
            <p className="guarantees__facts">
                На все запчасти распространяется гарантия заводов-производителей.<br />
                Все вопросы, связанные с условиями и сроками гарантии,
                Вы можете задать нашим менеджерам.
            </p>
            ...
            <ol className="guarantees__rules-list">
                ...
                <li className="guarantees__rule">
                    В случае <strong>обмена</strong> вместе с некачественной продукцией необходимо
                    отправить следующий пакет документов:
                ...
                <li className="guarantees__rule">
                    В случае <strong>возврата</strong> продукции к выше перечисленным документам
                    необходимо приложить накладную и счет фактуру на возврат.
                </li>
            </ol>
            <a className="guarantees__download-link" href="">
