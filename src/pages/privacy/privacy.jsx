                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        ...
                        <li className="privacy__sub-item">
                            ...
                            сети интернет по сетевому адресу <strong>https://utd.ru</strong>;
                        </li>
                        <li className="privacy__sub-item">
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                            ...
                            Пользователем сайта <strong>https://utd.ru</strong>.
                        </li>
                        <li className="privacy__sub-item">
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                            ...
                            <strong>https://utd.ru</strong>. Заполняя соответствующие формы и/или
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        ...
                        <li className="privacy__sub-item">
                            ...
                            Интернет по адресу <strong>https://utd.ru/privacy</strong>.
                        </li>
                    </ol>
                </li>
            </ol>
