            ...
            <ol className="privacy__list">
                <li className="privacy__list-item">
                    ...
                    <p className="privacy__text">
                        ...
                        <strong>ООО ТД «УралТехДеталь»</strong> (далее – Оператор).
                    </p>
                    <ol  className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        ...
                        <li className="privacy__sub-item">
                            ...
                            сети интернет по сетевому адресу <strong>https://utd174.ru</strong>;
                        </li>
                        <li className="privacy__sub-item">
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                            ...
                            Пользователя посредством отправки электронных писем; прием заявок от
                            Пользователя на покупку товаров; установление обратной связи с
                            Пользователем сайта <strong>https://utd174.ru</strong>.
                        </li>
                        <li className="privacy__sub-item">
                            ...
                            почты <strong>89193151000@mail.ru</strong> с пометкой «Отказ от
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                            ...
                            <strong>https://utd174.ru</strong>. Заполняя соответствующие формы и/или
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        ...
                        <li className="privacy__sub-item">
                            ...
                            <strong>89193151000@mail.ru</strong> с пометкой «Актуализация
                            персональных данных».
                        </li>
                        <li className="privacy__sub-item">
                            ...
                            <strong>89193151000@mail.ru</strong> с пометкой «Отзыв согласия на
                ...
                <li className="privacy__list-item">
                    ...
                    <ol className="privacy__sub-items-list">
                        <li className="privacy__sub-item">
                            ...
                            <strong>89193151000@mail.ru.</strong>
                        </li>
                        <li className="privacy__sub-item">
                        ...
                        <li className="privacy__sub-item">
                            ...
                            Интернет по адресу <strong>https://utd174.ru/privacy</strong>.
                        </li>
                    </ol>
                </li>
            </ol>
